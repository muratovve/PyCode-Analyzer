...
A tool to analyze, deobfuscate, and inspect potentially malicious Python scripts. Now features a modern **Web Interface** alongside the classic Command Line Interface.
